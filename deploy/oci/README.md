...
~~~sh
docker buildx build --platform linux/amd64,linux/arm64 --file Dockerfile --tag agent-pontifex-lambdas:dev .
~~~
...
docker buildx build --platform linux/amd64,linux/arm64 \
  --file Containerfile --output type=oci,dest=tmp/agent-pontifex-lambdas.oci .
~~~
